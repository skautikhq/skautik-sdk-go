...
func NewImageResponse(data Image) *ImageResponse {
	this := ImageResponse{}
	this.Data = data
	return &this
}
...
func (o *ImageResponse) GetData() Image {
	if o == nil {
		var ret Image
		return ret
	}
...
func (o *ImageResponse) GetDataOk() (*Image, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ImageResponse) SetData(v Image) {
	o.Data = v
}
